Shader "Skybox/Physically-Based Procedural"
{
    Properties
    {
        ...
        _SunsetTint("Sunset Tint", Color) = (1, 0.55, 0.3, 1)
        ...
        _FogEnd("Fog End Height", Range(-1.0, 1.0)) = 0.5
        ...
        _NightAmbientColor ("Night Ambient Color", Color) = (0.05, 0.08, 0.15, 1)
        ...
        _RayleighScaleHeight ("Rayleigh Scale Height (km)", Float) = 8.0
        _MieScaleHeight ("Mie Scale Height (km)", Float) = 1.2
        _MieG ("Mie Anisotropy (g)", Range(-0.99, 0.99)) = 0.8

        [Header(Performance and Quality)]
        _SampleCount("View Samples", Range(1, 32)) = 16
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _SunFadeStartAngle, _SunFadeEndAngle;
            int _SampleCount;
            fixed4 _GroundColor;
